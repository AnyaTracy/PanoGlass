...
class GETR(nn.Module):
    ...
    def __init__(self):
        ...
        self.lcfi_3 = LCFI(2048, lcfiType=2)
        self.lcfi_2 = LCFI(1024, lcfiType=2)
        self.lcfi_1 = LCFI(512, lcfiType=1)
        self.lcfi_0 = LCFI(256, lcfiType=1)
        self.lcfi_channel_3 = nn.Conv2d(512, 256, kernel_size=1)
        self.lcfi_channel_1 = nn.Conv2d(128, 256, kernel_size=1)
        self.lcfi_channel_0 = nn.Conv2d(64, 256, kernel_size=1)
