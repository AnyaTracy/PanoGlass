...
```shell
python tools/train.py configs/segnext/segnext_mscan-b_1x16_512x512_adamw_160k_ade20k.py [optional arguments]

python3 tools/train.py configs/PanoGlass/myDecoder_convnext_xlarge_fp16_640x640_80k_voc12.py --no-validate --resume-from work_dirs/myDecoder_convnext_xlarge_fp16_640x640_80k_voc12/iter_8000.pth
```
